...
def multiple_value_rule(features):
    for feature in features[1:]:
        ...
        index_value=pd.Series(train_value.index.tolist() + train_all_value.index.tolist()).drop_duplicates().sort_values()
...
train.to_csv("E:\Python_env\python_project\COMP 9417\Project/new_train_30perc.csv", index=False)